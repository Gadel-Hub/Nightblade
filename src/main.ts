...
const game = new Phaser.Game({
  ...
  scene: window.location.hash === '#dev' ? [DevelopmentScene, ArtScene, Level1Scene]
    : window.location.hash === '#level1' ? [Level1Scene, DevelopmentScene, ArtScene] : [ArtScene, DevelopmentScene, Level1Scene],
});
